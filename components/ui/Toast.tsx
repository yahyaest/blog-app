...
>(function Toast({ onClose, text }, forwardedRef) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center justify-between overflow-hidden whitespace-nowrap rounded-lg border border-gray-600 bg-dark dark:bg-light text-sm text-light dark:text-dark shadow-sm backdrop-blur">
          <RadixToast.Description className="truncate p-4">
            {text}
          </RadixToast.Description>
          <RadixToast.Close className="border-l border-gray-600/50 p-4 text-gray-500 transition hover:bg-gray-600/30 hover:text-gray-300 text-light dark:text-dark">
